/**
 * ui-components.js — Shared client-side UI component library.
 *
 * ES-module imported by the definition page (definition.hbs). Provides
 * reusable, theme-aware UI building blocks for the autogenerated
 * Grasshopper experiment pages.
 *
 * Exports:
 *  - Theme system: initThemes(), applyThemeToPage(), DAISY_THEMES, THEME_DATA
 *  - Color palettes: getThemePalette() — returns per-theme color arrays for 3D geometry
 *  - Compute controls: renderComputeControls() — live toggle + compute button
 *  - View controls: renderViewControls() — Iso / Top / Front / Right camera buttons
 *  - Theme selector: renderThemeSelector() — dropdown to switch DaisyUI themes
 *  - Startup overlay: showStartupOverlayAndWait() — TV-test-pattern loading screen
 *    shown while the Rhino Compute server boots up
 */
